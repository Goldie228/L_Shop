/**
 * Компонент формы регистрации - L_Shop Frontend
 * Форма для регистрации пользователей с атрибутом data-registration
 */
 ...
 * Включает обязательный атрибут data-registration
 */
